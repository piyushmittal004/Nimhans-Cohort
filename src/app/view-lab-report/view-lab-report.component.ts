...
@ViewChild('op2',{read: ElementRef}) op2:ElementRef;
@ViewChild('op3',{read: ElementRef}) op3:ElementRef;
@ViewChild('op4',{read: ElementRef}) op4:ElementRef;
@ViewChild('op5',{read: ElementRef}) op5:ElementRef;
